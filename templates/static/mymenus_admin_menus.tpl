            ...
            <tr class='odd'>
                <td>
                    <form id='filter_form' name='filter_form' action='' method='post' enctype='multipart/form-data'>
                        ...
                        &nbsp;
                        <input type='submit' id='filter_submit' class='formButton' title='<{$smarty.const._AM_MYMENUS_BUTTON_FILTER}>' value='<{$smarty.const._AM_MYMENUS_BUTTON_FILTER}>'
                               name='filter_submit'>
            ...
            <{foreach item=menu key=key from=$menus}>
                <tr class="<{cycle values="even,odd"}>" align="center">
                    ...
                    <td>
                        ...
                        <a href="links.php?op=list&amp;mid=<{$menu.id}>"><img src="<{xoModuleIcons16 forward.png}>" title="<{$smarty.const._AM_MYMENUS_ACTION_GOTO_MENU}>"
