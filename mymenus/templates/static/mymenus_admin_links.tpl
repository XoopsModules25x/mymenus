<style type="text/css">
    .icon-1:before, .icon-0:before{content:"\2212"}
    .icon-1 {width: 16px; height: 16px; background: url('<{xoModuleIcons16 1.png}>') 0 0 no-repeat transparent !important; border: 0 none !important; padding:0; margin:1px 2px 0 0 !important; cursor: pointer}
    .icon-0 {width: 16px; height: 16px; background: url('<{xoModuleIcons16 0.png}>') 0 0 no-repeat transparent !important; border: 0 none !important; padding:0; margin:1px 2px 0 0 !important; cursor: pointer}
</style>
...
<div class="width100">
    ...
    <div class="floatright">
        <form method="POST" action="admin_links.php?op=list" id="changemenu">
            <select name="mid" id="menu_id" class="select-options" onchange="this.form.submit()">
                <{foreach item=title from=$menus_list key=id }>
                <option value="<{$id}>"
                <{if $mid == $id}> selected='selected'<{/if}>><{$title}></option>
                <{/foreach}>
            </select>
<!--
        ...
        <li id="mod_<{$menu.id}>" class="ui-state-default">
            <div>
                <table class="width100">
                    <tr>
                        <td width="12%">
                            <img style="padding: 0 5px 0 2px;" src="<{xoAppUrl}>modules/mymenus/assets/images/actions/move_vertical-16.png">
                            <{$menu.title}>
                        </td>
                        ...
                        <td width="4%" class="discrete">
                            <span  id="hidden-result_<{$menu.id}>" style="display:none;">
                                <img style="margin: 3px 4px 0 0;" src="../assets/images/loading.gif" title="loading" alt="loading" />
                            </span>
                            ...
                            <a href="admin_links.php?mid=<{$menu_id}>&amp;op=del&amp;id=<{$menu.id}>">
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="4%" class="discrete">
                                            ...
                                            <input id="id-<{$smenu.id}>" type="button" title="<{$smarty.const._AM_MYMENUS_ACTION_TOGGLE}>" class="toggleBtn icon-<{$smenu.visible}>" onclick="itemOnOff(<{$smenu.id}>)">

                                            <a href="#" onclick="showWindow(<{$smenu.id}>)">
                                                <img style="padding: 1px 2px 0 0" src="<{xoModuleIcons16 edit.png}>" title="<{$smarty.const._EDIT}>" alt="<{$smarty.const._EDIT}>"/>
                                            </a>
                                            <a href="admin_links.php?mid=<{$smenu_id}>&amp;op=del&amp;id=<{$smenu.id}>">
                                                <img style="padding: 1px 2px 0 0" src="<{xoModuleIcons16 delete.png}>" title="<{$smarty.const._DELETE}>" alt="<{$smarty.const._DELETE}>"/>
                                            </a>
                                        </td>
                                    </tr>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="4%" class="discrete">
                                                          ...
                                                          <input id="id-<{$ssmenu.id}>" type="button" title="<{$smarty.const._AM_MYMENUS_ACTION_TOGGLE}>" class="toggleBtn icon-<{$ssmenu.visible}>" onclick="itemOnOff(<{$ssmenu.id}>)">

                                                          <a href="#" onclick="showWindow(<{$ssmenu.id}>)">
                                                               <img style="padding: 1px 2px 0 0" src="<{xoModuleIcons16 edit.png}>" title="<{$smarty.const._EDIT}>" alt="<{$smarty.const._EDIT}>"/>
                                                          </a>
                                                          <a href="admin_links.php?mid=<{$ssmenu_id}>&amp;op=del&amp;id=<{$ssmenu.id}>">
                                                               <img style="padding: 1px 2px 0 0" src="<{xoModuleIcons16 delete.png}>" title="<{$smarty.const._DELETE}>" alt="<{$smarty.const._DELETE}>"/>
                                                          </a>
                                                        </td>
                                                    </tr>
