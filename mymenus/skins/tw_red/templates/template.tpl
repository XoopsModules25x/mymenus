...
<{                    if 0 == $menu.level}>
                    <li<{if $menu.css | $menu.selected}> class="<{/if}><{if $menu.selected}>active<{/if}><{if $menu.css}> <{$menu.css}><{/if}><{if $menu.css | $menu.selected}>"<{/if}>>
                        <a href="<{$menu.link}>" target="<{$menu.target}>" alt="<{$menu.alt_title}>" title="<{$menu.alt_title}>">
                            <span class="menu-left"></span>
                            <span class="menu-mid"><{if $menu.image}><img src="<{$menu.image}>" /><{/if}><{$menu.title}></span>
...
<{                            if ($xlanguage && (($menu.title|strstr:$myStr) OR ($menu.image|strstr:$myStr)) OR !$xlanguage)}>
                                <li<{if $sub.class}> class="<{$sub.css}>"<{/if}>>
                                    ...
                                    <{if $sub.image}><img src="<{$sub.image}>" alt="<{$sub.alt_title}>" /><{/if}><{$sub.title}></a>
                                </li>
<{                            /if}>
<{                          /if}>
<{                        /foreach}>
