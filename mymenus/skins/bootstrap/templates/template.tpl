...
<{      if $menu.image}><img class="menu-image" src="<{$menu.image}>" /> <{/if}><{$menu.title}> <b class="caret"></b></a>
<{      elseif $menu.hassub && $menu.level == 1}>
          <li<{if $menu.selected | $menu.css}> class="<{/if}><{if $menu.selected}>active<{/if}><{if $menu.css}> <{$menu.css}><{/if}><{if $menu.selected | $menu.css}>"<{/if}>>
          <a href="<{$menu.link}>" target="<{$menu.target}>" alt="<{$menu.alt_title}>" title="<{$menu.alt_title}>">
<{      if $menu.image}><img class="menu-image" src="<{$menu.image}>" /> <{/if}><{$menu.title}> <i class="glyphicon glyphicon-arrow-right"></i></a>
<{      else}>
          <li<{if $menu.selected | $menu.css}> class="<{/if}><{if $menu.selected}>active<{/if}><{if $menu.css}> <{$menu.css}><{/if}><{if $menu.selected | $menu.css}>"<{/if}>>
          <a href="<{$menu.link}>" target="<{$menu.target}>" alt="<{$menu.alt_title}>" title="<{$menu.alt_title}>">
<{        if $menu.image}><img class="menu-image" src="<{$menu.image}>" /> <{/if}><{$menu.title}></a><{/if}>
<{      /if}>
<{/if}>
